...
// document.ready(function tamano(){
//     var height = window.height();
//     this.espacio.height(height)
// });
      ...
      <HomeStyled>
        <div>
          <div>
            ...
            <button id="boton" color="info" className={`outline waves-effect ${this.state.activeClass}`}>Contactanos</button>
